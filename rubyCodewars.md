...
<!-- solution -->
def cookie(x)
  x.kind_of?(String) ? "Who ate the last cookie? It was Zach!" : x.kind_of?(Integer) || x.kind_of?(Float) ? "Who ate the last cookie? It was Monica!" : "Who ate the last cookie? It was the dog!"
end
